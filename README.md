...
Download the code:
Save the python script as task_manager.py.
...
First Run:
The application will automatically create a file named sarthak.db in the same directory.
...
├── sarthak.db         # Database file (created auto-magically)
